...
public class Bread_Factory_Account {
	...
	// *********** //
		...
		String fileName = "/Users/DUVALL NOTEBOOK/workspace/project 2018 version 8/src/data/bread_factory.csv";
		...
		try {
			...
			while (inputStream.hasNextLine()) {
				...
				outputStream = new PrintWriter("/Users/DUVALL NOTEBOOK/workspace/project 2018 version 8/src/public_html_Bread_Factory/Bread_Foctory_Statement"+ numCounter +".html");
				
				outputStream.println("<!DOCTYPE html>");
				outputStream.println("<html>");
				outputStream.println("        <head>");
				outputStream.println("                <title>Bread Factory Statement"+ numCounter +"</title>");
				...
				outputStream.println("<nav> <a href='mainpage.html'>Main page</a> <a href='bread_factory_home.html'>Bread Factory Home page</a><a href='bread_factory Summary.html'>Bread Factory Summary</a></nav>");
