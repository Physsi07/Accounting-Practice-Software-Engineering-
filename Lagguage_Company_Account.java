...
public class Lagguage_Company_Account {
	...
	// *********** //
		...
		String fileName = "/Users/DUVALL NOTEBOOK/workspace/project 2018 version 8/src/data/lagguge_company.csv";
		...
		try {
			...
			while (inputStream.hasNextLine()) {
				...
				outputStream = new PrintWriter("/Users/DUVALL NOTEBOOK/workspace/project 2018 version 8/src/public_html_Lagguage_Company/Lagguage_Company_Statement"+ numCounter +".html");
				
				outputStream.println("<!DOCTYPE html>");
				outputStream.println("<html>");
				outputStream.println("        <head>");
				outputStream.println("                <title>Lagguge Companyy Statement"+ numCounter +"</title>");
				...
				outputStream.println("<nav> <a href='mainpage.html'>Main page</a> <a href='lagguge_company home.html'>Lagguge company Home page</a><a href='lagguge_company Summary.html'>Lagguge Company Summary</a></nav>");
